...
indivParams = {'length': 4, 'mutationProbability': 0.03, 'trackAncestry': 'yes'}
#indivParams = {'length': 12, 'mutationProbability': 0.03, 'mutationAmplitude': 0.1}
evolParams = {'indivClass': Individual, 'populationSize': 40, 'printParetoFront': True, 'randomSeed': int(sys.argv[1])}
...
#comm = Communicator('evaluations.txt', 'individuals.txt') # for communicators.textFiles

comm = Communicator('/tmp/eval', '/tmp/indiv') # for testing
